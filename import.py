...
def create_table():
	...
	if 'io_data' not in a[0]:
		cur.execute("create table io_data(date varchar(30),ID varchar(12),name varchar(12),confidence varchar(10),gender varchar(10),\
	...
	if 'walk_data' not in a[0]:
		cur.execute("create table walk_data(date varchar(30),ID varchar(12),name varchar(12),gender varchar(10),confidence_gender varchar(12),\
